...
function createFilterTemplate (filters) {
  return `<nav class="main-navigation">
    ...
    <a href="#history" data-id="historywatchlist" class="main-navigation__item">History <span class="main-navigation__item-count">${filters.history.films.length}</span></a>
